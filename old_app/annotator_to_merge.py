...
class YOLOv8App(QWidget):
    ...
    def initUI(self):
        ...
        self.saveFolderButton = self.create_button('Select Save Folder', self.openFolderDialog)
        ...
        for widget in [self.loadVideoButton, self.loadFacesButton, self.saveFolderButton, self.saveCoordsCheckbox,
                       self.saveFramesCheckbox, self.frameSkipInput, self.runButton, self.annotateButton,
                       self.autoAnnotateInput, self.autoAnnotateButton, self.deleteFramesButton, self.progressLabel,
                       self.statusLabel]:
